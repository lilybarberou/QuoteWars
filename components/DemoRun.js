...
export default function DemoRun() {
    ...
    return (
        <div id='try-it' className='container px-2 relative mx-auto max-w-4xl mt-32 mb-20'>
            <h3 className='mb-5 text-2xl sm:text-4xl font-bold font-display'>
            ...
            <CodeBlock text={text} language='json' showLineNumbers={false} wrapLines theme={nord} customStyle={{ padding: '1.25rem' }} />
        </div>
    );
}
