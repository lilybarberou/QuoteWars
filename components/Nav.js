        ...
        <nav className="w-screen shadow-md bg-gradient-to-r from-indigo-500 to-sky-500 px-10 py-3 text-white text-lg font-bold flex justify-center">
            <div className="w-full sm:w-8/12 flex justify-between">
                <div className="flex items-center">
                    <Image src={Icon} width={40} height={37} alt="Quote Wars Logo" className="rounded-full" />
                    <span className="ml-4 cursor-default">Quote Wars</span>
                </div>
                <div className="flex items-center">
                    <a
                        className="flex items-center cursor-pointer hover:opacity-75"
                        href="https://github.com/Nahay/QuoteWars"
                        target="_blank"
                        rel="noreferrer"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22" className="fill-current text-gray-800">
                            <g data-name="Layer 2">
                                <path
